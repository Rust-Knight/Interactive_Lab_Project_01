...
public class StateMachineMB : MonoBehaviour
{
    ...
    public void ChangeStateToPrevious()
    {
        if (_previousState != null)
            ...
            Debug.LogWarning("This is no previous state to change!");
    }

        /* The StoreStateAsPrevious and ChangeStateToPrevious methods handle all our PreviousState handling. Being able to return to a previous state can be
